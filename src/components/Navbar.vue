...
<template>
    <!-- Hamburger button -->
    <button class="hamburger hamburger--collapse absolute top-4 right-4 z-10" type="button"
    ...
    <transition name="slide-fade">
        <nav v-show="isNavbarVisible" class="p-4 absolute right-0 h-full">
    ...
    <!-- <nav class=" p-4 absolute right-0 h-full">
        <ul class="flex flex-col space-y-8 text-primary h-full justify-center items-center">
            <li><a href="#home" class=" hvr-bob hover:text-white">
                    <Icon icon="ic:baseline-home" width="35" />
...
<style scoped> /* Hamburger button styles */
 ...
 /* Add slide & fade transition with improved durations */
